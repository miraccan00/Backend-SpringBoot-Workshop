...
* The original package name 'com.example.my-project2' is invalid and this project uses 'com.example.myproject2' instead.
...
* [Spring Web](https://docs.spring.io/spring-boot/docs/2.5.12/reference/htmlsingle/#web)
